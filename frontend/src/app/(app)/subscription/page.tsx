...
export default function SubscriptionPage() {
  ...
  const planNameKey = (code: string): string => {
    const map: Record<string, string> = {
      free: 'subscription.planFree',
      pro: 'subscription.planPro',
      agency: 'subscription.planAgency',
    };
              ...
              >
                ...
                <ul className="space-y-2 mb-6">
                  {[
                    ...
                    t('subscription.queryLimitPerBrand', {
                      n: plan.query_limit_per_brand,
                    }),
                    t('subscription.contentMonthlyLimit', {
                      n: plan.content_monthly_limit,
                    }),
