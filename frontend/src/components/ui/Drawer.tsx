...
export default function Drawer({
  ...
  const translateX = mounted ? 'translateX(0)' : `translateX(${slideFrom})`;
      ...
      >
        ...
        {footer && (
          <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
            {loading ? (
              <button
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-brand-600 rounded-lg opacity-75 cursor-not-allowed"
                disabled
              >
